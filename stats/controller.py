...
class Stats(object):
    ...
    def _general_article_year_month_lines_to_base_data(self, accesses, begin='0000-01-01', end='9999-12-31'):
        """
    ...
    def _general_article_year_month_lines_chart_to_gviz_data(self, accesses, begin='0000-01-01', end='9999-12-31'):
        ...
        """
        years = self._general_article_year_month_lines_to_base_data(accesses, begin=begin, end=end)
    ...
    def _general_article_year_month_lines_chart_to_csv_data(self, accesses, begin='0000-01-01', end='9999-12-31'):
        ...
        """
        data = self._general_article_year_month_lines_to_base_data(accesses, begin=begin, end=end)
    ...
    def thematic_area_pie_chart(self, collection):

        import pdb; pdb.set_trace()
        for journal in self.articlemeta.collection_journals(collection):
            pass
